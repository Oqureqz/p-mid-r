/*
  ...
  My version (pómidór): 
  - https://github.com/oqureqz/pómidór
  Original version (ptoszek.pl): 
  - https://github.com/jaczup/ptoszek.pl

  Contact with me: konrradus19@gmail.com

  Contributors:

  @oqureqz - main website  
*/
...
const VIDEOS = [
  'media/videos/temu.mp4',
  'media/videos/minkraft.mp4',
  'media/videos/makeitbetterxddd.mp4',
  'media/videos/sraka.mp4',
  'media/videos/fredi.mp4',
  'media/videos/resetcharacter.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/ogur.jpg',
  'media/images/oqureqz.jpg',
  'media/images/chuj.png',
  'media/images/panpomidor.png',
  'media/images/cośinteresującego.jpg',
  'media/images/guwno.jpeg',
  'media/images/minkraft.jpg',
  'media/images/balz.jpeg'
]

const PHRASES = [
  'hello my name is ogur lol',
  'ur mama',
  'wgl co u cb bo u mn dbr',
  'srakaaaaaaaaaa',
  'print("gówno")'
  'konrradus.aternos.me jest czasami aktywne',
  'essaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  '🍅🥒🍅🥒🍅🥒🍅🥒🍅🥒🍅🥒'
]
